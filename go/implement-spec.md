...
- Confirm tests to write, files to touch, function signatures, behavior rules,
  error handling, concurrency/lifecycle requirements, and acceptance
  criteria.
...
- Preserve public API, compatibility, error contracts, and existing behavior
