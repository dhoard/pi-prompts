...
| `go-performance-review.md` | Go performance review | You have profile, benchmark, or repository evidence and need performance recommendations |
...
```text
go-code-coverage.md ──► Go coverage improvement
go-performance-review.md ──► Go performance review
