...
| `go-code-coverage.md` | Go coverage improvement | You want one safe, deterministic iteration to improve test coverage |
| `go-performance-review.md` | Go performance review | You have profile or benchmark data and need performance recommendations |
...
```
go-code-coverage.md ──► One focused coverage improvement iteration
go-performance-review.md ──► Performance analysis from profile data
...
- **Playbook prompts** (`go-code-coverage.md`, `go-performance-review.md`)
  follow: Objective → Priorities/Rules → Project Context → Workflow →
  Output Format.
