...
Go repositories. This is a reference document, not an executable
...
- Understand existing naming, structure, error handling, validation, and
...
5. Changing public API or error contracts unintentionally.
6. Applying personal style instead of repository style.
7. Ignoring nil or edge-case behavior.
