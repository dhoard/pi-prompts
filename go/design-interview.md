...
- Which components, packages, or services are affected?
...
- What error types and error messages are appropriate?

### Concurrency and Lifecycle

- Are there goroutine or synchronization requirements? What is the locking
  strategy?
