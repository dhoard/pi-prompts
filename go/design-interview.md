...
- Identify current architecture, naming, API, error handling, and
  validation patterns.
...
- Error types, messages, wrapping, propagation, or recovery behavior.

### Concurrency and Lifecycle

- Goroutine, channel, mutex, context, and lifecycle requirements.
