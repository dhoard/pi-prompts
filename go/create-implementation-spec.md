...
New functions, methods, and types to create, or `Not applicable`.

### Function Signatures

Exact signatures for every changed or new function or method, including receiver, parameters, and return values. Use `Not applicable` if no signatures change.
...
Invalid inputs, system failures, errors, messages, wrapping, propagation,
and recovery behavior, or `Not applicable`.

### Concurrency and Lifecycle

Goroutine, channel, mutex, context, and lifecycle guarantees, cleanup, cancellation, and ownership
