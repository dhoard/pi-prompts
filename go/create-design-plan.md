...
error handling, concurrency/lifecycle model, test strategy, and
...
- Identify constraints to preserve, including language/runtime version,
  compatibility, public API semantics, error contracts, and nil-safety
...
Exact files and functions, methods, and types inspected. Include repository patterns that must
be preserved.
...
Expected failures and error handling behavior, or `Not applicable`.
...
Goroutine, channel, mutex, context, and lifecycle implications, or `Not applicable`.
