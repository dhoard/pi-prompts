...
- **Don't touch what you weren't asked to touch.** If you're fixing a bug in method A and notice method B has a weird variable name, leave it. Pre-existing issues are not your problem unless asked.
...
- For coverage improvement guidance, see `java-code-coverage.md`.
